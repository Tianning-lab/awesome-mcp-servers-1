...
- [Property Comps](https://github.com/Tianning-lab/property-comps-mcp-server) - Comparable property sales data across 11 global markets (UK, France, Dubai, Singapore, NYC, and more). 44M+ government-recorded transactions from official registries. Search comps, get area stats, list markets.
